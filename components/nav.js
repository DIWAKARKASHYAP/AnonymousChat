...
const Nav = () => {
    ...
    const connectMetamask = async () => {
        ...
        setMAddress(await signer.getAddress());
    };
                        ...
                        <ul className="font-medium flex items-center flex-col p-4 md:p-0 mt-4 border  rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0  bg-gray-800 md:bg-gray-900 border-gray-700">
                            ...
                            <li>
                                <button
                                    ...
                                    className="border focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center focus:ring-gray-600 bg-gray-800 border-gray-700 text-white hover:bg-gray-700 mr-2 "
                                >
                                    <svg
                                        aria-hidden="true"
